<!-- source: https://learn.microsoft.com/en-us/windows/apps/design/basics/commanding-basics
     fetched: 2026-09-19
     licence: CC BY 4.0 — https://github.com/MicrosoftDocs/windows-dev-docs/blob/docs/LICENSE
     title: Commanding basics - Windows apps
     ms.date: 2020-09-24 -->
...
[image: Predictive text entry image]
...
WinUI also provides a set of traditional menus and context menus; for more info, see Menus and context menus.
...
[image: commandbar content area image]
