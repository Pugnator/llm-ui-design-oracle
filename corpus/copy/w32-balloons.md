<!-- source: https://learn.microsoft.com/en-us/windows/win32/uxguide/ctrl-balloons
     fetched: 2026-09-19
     licence: CC BY 4.0 — https://github.com/MicrosoftDocs/win32/blob/docs/LICENSE
     title: Win32 UX Guide — Balloons -->
...
[image: Screenshot that shows a balloon indicating that Caps Lock is on.]
...
**Incorrect:** [image: screen shot of a balloon: logon unsuccessful]
...
**Incorrect:** [image: screen shot of two balloons pointing to one box]
...
**Correct:** [image: screen shot of a balloon displayed below its control]

**Incorrect:** [image: screen shot of a balloon displayed above its control]
...
[image: screen shot of a balloon indicating caps lock is on]
...
[image: screen shot of a balloon indicating pin code limits]
...
[image: screen shot of a balloon indicating incorrect input]
...
[image: screen shot of a balloon indicating character limits]
...
[image: screen shot of a balloon with title and body text]
