<!-- source: https://learn.microsoft.com/en-us/windows/win32/uxguide/vis-std-icons
     fetched: 2026-09-19
     licence: CC BY 4.0 — https://github.com/MicrosoftDocs/win32/blob/docs/LICENSE
     title: Win32 UX Guide — Standard Icons -->
...
[image: screen shot of four standard icons]
...
[image: screen shot of a warning to back up data]
...
[image: screen shot of a misleading use of a warning icon]
...
[image: screen shot informing users of correct input]
...
[image: screen shot of warning icon used unnecessarily]
...
[image: screen shot of warning icon used with reminder]
...
[image: screen shot of error icon used with error text]

**Incorrect:**

[image: screen shot of warning icon used with error text]
...
| Context | When to use |
|---|---|
| Dialog boxes | Use for critical errors only. (don't use standard icons for non-critical errors.)   [image: Screenshot that shows the error icon used with error message] |
| In-place errors | Use for all errors.   [image: screen shot of error icon used with an error message.] |
| Notifications | Use for critical errors only. (for action failures.)   [image: Screenshot that shows an error icon used with a notification error message.] |
...
| Context | When to use |
|---|---|
| Dialog boxes | Use for all warnings.   [image: screen shot warning of file-name extension change] |
| In-place warnings | Use to identify the text as a warning.   [image: screen shot of warning of not enough free space] |
| Notifications | Use for all warnings. (for non-critical system events.)   [image: screen shot of low-battery warning notification] |
| Balloons | Use for special conditions.   [image: screen shot of balloon warning of caps lock on] |
| Banners | Use to draw attention to the banner.   [image: screen shot of banner with warning of missing tpm] |
...
[image: screen shot warning not to stop system restore]

**Incorrect:**

[image: screen shot of warning about dismissing reminders]
...
[image: screen shot warning of a potentially unsafe file]
...
| Balloons | Don't use. |
| Banners | use to draw attention to the banner.   [image: screen shot of banner with settings information] |
