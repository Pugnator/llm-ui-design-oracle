<!-- source: https://learn.microsoft.com/en-us/windows/win32/uxguide/mess-notif
     ...
     title: Notifications (Design basics) - Win32 apps | Microsoft Learn
...
- Use notifications only if you really need to. When you display a notification, you are potentially interrupting users or even annoying them. Make sure that interruption is justified.
...
- If you use notifications, make it a good user experience. Don't try to force users to see your notifications. If users are so immersed in their work that they don't see your notifications, your design is good.
