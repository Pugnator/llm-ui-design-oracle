<!-- source: https://learn.microsoft.com/en-us/style-guide/numbers
     fetched: 2026-09-19
     licence: CC BY 4.0 (Microsoft Learn documentation) — https://github.com/MicrosoftDocs
     title: Numbers - Microsoft Style Guide | Microsoft Learn
     ms.date: 2022-05-13T00:00:00Z -->
...
Form a negative number with a minus sign, not an en dash:
Example
−79
...
Global tip Machine translation might not translate these abbreviations correctly. Also, an abbreviated form might not be available or might be longer in the target language, so allow space for expansion in localized content.
