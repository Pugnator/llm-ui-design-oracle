<!-- source: https://design-system.service.gov.uk/patterns/validation/
     ...
     title: Recover from validation errors – GOV.UK Design System
     ms.date:  -->
...
If you do use this sort of validation, make sure you validate in a way that’s accessible.
...
You’ll always need to carry out server side validation, even if you use client side validation. This is because there’s no guarantee that client side validation will work in all circumstances. For example, the user can bypass client side validation, or JavaScript can fail to load.
