<!-- source: https://design-system.service.gov.uk/patterns/problem-with-the-service-pages/
     ...
     title: There is a problem with the service pages – GOV.UK Design System
     ms.date:  -->
...
Open this example in a new tab: service has a specific page that includes numbers and opening times – there is a problem with the service pages
...
You might choose to link to a ‘contact information’ page, such as one shown in the ‘Contact a department or service team’ pattern.

### Service has a specific page that includes numbers and opening times

Open this example in a new tab: service has a specific page that includes numbers and opening times – there is a problem with the service pages second
...
Open this example in a new tab: service has offline support but no specific page that includes numbers and opening times – there is a problem with the service pages
...
Open this example in a new tab: a link to another service – there is a problem with the service pages
